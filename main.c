...
"<p>Olá, seja bem-vindo ao controlador de acesso de Filipe!</p>"
"<p>Este é um servidor que foi criado para demonstrar o funcionamento de um servidor web.</p>"
"<p>Este servidor foi criado por Filipe Herlon.</p>"
"<p>Este servidor foi criado para a disciplina de Introdução à programação.</p>"
